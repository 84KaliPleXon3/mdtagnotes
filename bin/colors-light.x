...
<hlType>
    <ext>cpp hpp c h</ext>
    <hlRule><name>keywords</name><color>#050fcb</color><hlPattern>\bif\b|\belse\b|\bchar\b|\busing\b|\bthrow\b|\bnew\b|\bbool\b|\bvoid\b|\bvirtual\b|\bunsigned\b|\bunion\b|\bstruct\b|\bstatic\b|\bsigned\b|\bshort\b|\bpublic\b|\bprotected\b|\bprivate\b|\boperator\b|\bnamespace\b|\binline\b|\bfriend\b|\bexplicit\b|\benum\b|\bdouble\b|\blong\b|\bclass\b|\bint\b|\bconst\b</hlPattern></hlRule>
    <hlRule><name>class</name><color>#0187c3</color><hlPattern>\b[A-Za-z]+::</hlPattern></hlRule>
    ...
    <hlRule><name>number</name><color>#aa0000</color><hlPattern>\b[\d]+</hlPattern></hlRule>
    ...
    <hlRule><name>preprocessor</name><color>#9d1b53</color><hlPattern>^#\w+</hlPattern></hlRule>
...
<hlType>
    <ext>xml html</ext>
    <hlRule><name>tag open</name><color>#9d1b53</color><hlPattern>(<|</)[^ >]+>*</hlPattern></hlRule>
    <hlRule><name>tag close</name><color>#9d1b53</color><hlPattern>>|/></hlPattern></hlRule>
    <hlRule><name>attribute</name><color>#244ea5</color><hlPattern>\s\w+=</hlPattern></hlRule>
    <hlRule><name>string</name><color>#017500</color><hlPattern>"[^"]*"</hlPattern></hlRule>
...
<hlType>
    ...
    <hlRule><name>system</name><color>#00007f</color><hlPattern>\bsqlerrm\b|\bsqlcode\b|\bothers\b|\bsysdate\b|\b%type\b|\b%rowtype\b|\braise_application_error\b|\btrue\b|\bfalse\b|\bnull\b</hlPattern></hlRule>
    <hlRule><name>operator</name><color>#244ea5</color><hlPattern>\s*(/|,|\||=|>|<|<=|>=|!=|<>|\.|;|:|::|\(|\)|\*)\s*</hlPattern></hlRule>
    <hlRule><name>number</name><color>#aa0000</color><hlPattern>\b[\d]+</hlPattern></hlRule>
    <hlRule><name>string</name><color>#017500</color><hlPattern>'[^']*.</hlPattern></hlRule>
    <hlRule><name>comment</name><color>#aaaaaa</color><hlPattern>--[^\n]*</hlPattern></hlRule>
...
<hlType>
    ...
    <hlRule><name>attention</name><color>#ea4335</color><hlPattern>^![^\n]*</hlPattern></hlRule>
    <hlRule><name>header</name><color>#9d1b53</color><hlPattern>^\.[^\.][^\n]+</hlPattern></hlRule>
    <hlRule><name>comment</name><color>#aaaaaa</color><hlPattern>^[=|\?][^=\?][^\n]*</hlPattern></hlRule>
</hlType>
